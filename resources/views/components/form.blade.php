...
<div>
    ...
    <select name="traccao" id="traccao">
        <option value="Integral" {{ old('traccao', $car->traccao ?? '') == 'Integral' ? 'selected' : '' }}>Integral</option>
        <option value="Tracção dianteira" {{ old('traccao', $car->traccao ?? '') == 'Tracção dianteira' ? 'selected' : '' }}>Tracção dianteira</option>
        <option value="Tracção traseira" {{ old('traccao', $car->traccao ?? '') == 'Tracção traseira' ? 'selected' : '' }}>Tracção traseira</option>
    </select>
</div>
...
<div>
    ...
    <select name="caixa" id="caixa">
        ...
        <option value="Automática" {{ old('caixa', $car->caixa ?? '') == 'Automática' ? 'selected' : '' }}>Automática</option>
    </select>
</div>
...
<div>
    ...
    <select name="segmento" id="segmento">
        <option value="Cabrio" {{ old('segmento', $car->segmento ?? '') == 'caCabriobrio' ? 'selected' : '' }}>Cabrio</option>
        ...
        <option value="Coupé" {{ old('segmento', $car->segmento ?? '') == 'couCoupépe' ? 'selected' : '' }}>Coupé</option>
